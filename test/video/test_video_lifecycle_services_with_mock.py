...
class TestVideoLifecycleServicesWithMock(unittest.TestCase):
    ...
    def test_start_video_session(self):
        """
        Verifica que start_video_session cree una sesión correcta, llame a open_stream
    ...
    def test_stop_video_session(self):
        """
        Verifica que stop_video_session actualice el estado a STOPPED y llame a close_stream.
        """
        session_id = self.video_service.start_video_session()
    ...
    def test_start_video_session_failure(self):
        """
        Simula que open_stream retorna False, lo cual debe provocar que start_video_session lance una excepción.
        """
        ...
        with self.assertRaises(Exception) as context:
            self.video_service.start_video_session()
